    ...
    while (1) {
        ...
        while (1) {
            ...
            if (v9 + (-v6 + 256 <= (v10 + 257 - v9) % 257 ? -v6 + 256 : (v10 +
                                                                         ...
                                                                         v9) %
                      257) <= 257) {
                core_read_shared(sa2, a3, v9, v6, v6 + (-v6 + 256 <= (v10 +
                                                                      257 -
                                                                      v9) %
                                                        257 ? -v6 + 256 : (v10 +
                                                                           257 -
                ...
                core_read_shared(sa2, a3, v9, v6, v6 + (-v9 + 257) - 1);
                core_read_shared(sa2, a3, 0, v6 + (-v9 + 257), v6 + (-v9 +
                                                                     257) +
                                 (-v6 + 256 <= (v10 + 257 - v9) % 257 ? -v6 +
                                  256 : (v10 + 257 - v9) % 257) - (-v9 + 257) -
                                 1);
            }
            la0[0] = (v9 + (-v6 + 256 <= (v10 + 257 - v9) % 257 ? -v6 +
        ...
        while (1) {
            ...
            if (v23 + (-v19 + 256 <= -((v23 + 257 - v22) % 257) + 256 ? -v19 +
                ...
                core_write_local(la7, a15, v23, v19, v19 + (-v19 + 256 <=
                                                            -((v23 + 257 -
                                                               v22) % 257) +
                                                            256 ? -v19 +
                                                            256 : -((v23 + 257 -
                ...
                core_write_local(la7, a15, v23, v19, v19 + (-v23 + 257) - 1);
                core_write_local(la7, a15, 0, v19 + (-v23 + 257), v19 + (-v23 +
                                                                         257) +
                                 ((-v19 + 256 <= -((v23 + 257 - v22) % 257) +
                                   256 ? -v19 + 256 : -((v23 + 257 - v22) %
                                                        257) + 256) - (-v23 +
                                                                       257)) -
                                 1);
            }
            la5[0] = (v23 + (-v19 + 256 <= -((v23 + 257 - v22) % 257) +
                             256 ? -v19 + 256 : -((v23 + 257 - v22) % 257) +
                             256)) % 257;
            la6[0] = (v23 + (-v19 + 256 <= -((v23 + 257 - v22) % 257) +
                             256 ? -v19 + 256 : -((v23 + 257 - v22) % 257) +
                             256)) % 257;
