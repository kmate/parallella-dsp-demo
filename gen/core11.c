...
volatile uint32_t *const la54 = (uint32_t *) 2292199440;
volatile uint32_t *const la55 = (uint32_t *) 2292199444;
volatile uint32_t *const la56 = (uint32_t *) 8196;
volatile float _Complex *const la57 = (float _Complex *) 8200;
volatile uint32_t *const la59 = (uint32_t *) 12304;
volatile uint32_t *const la60 = (uint32_t *) 12308;
