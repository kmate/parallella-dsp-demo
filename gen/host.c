...
int main()
{
    ...
    while (1) {
        ...
        while (1) {
            ...
            v48 = a47[0];
            if (v48 + (-v40 + 256 <= -((v48 + 257 - v46) % 257) + 256 ? -v40 +
                       256 : -((v48 + 257 - v46) % 257) + 256) <= 257) {
                host_write_shared(&shm1, a36, v48, v40, v40 + (-v40 + 256 <=
                                                               -((v48 + 257 -
                                                                  v46) % 257) +
                                                               256 ? -v40 +
                                                               256 : -((v48 +
                ...
                host_write_shared(&shm1, a36, v48, v40, v40 + (-v48 + 257) - 1);
                host_write_shared(&shm1, a36, 0, v40 + (-v48 + 257), v40 +
                                  (-v48 + 257) + ((-v40 + 256 <= -((v48 + 257 -
                                                                    v46) %
                                                                   257) +
                                                   256 ? -v40 + 256 : -((v48 +
                                                                         257 -
            ...
            a49[0] = (v48 + (-v40 + 256 <= -((v48 + 257 - v46) % 257) +
                             256 ? -v40 + 256 : -((v48 + 257 - v46) % 257) +
                             256)) % 257;
            host_write_local(&group0, 0, 0, la1, a49, 0, 0, 0);
            r38 = v40 + (-v40 + 256 <= -((v48 + 257 - v46) % 257) + 256 ? -v40 +
                         256 : -((v48 + 257 - v46) % 257) + 256);
        }
        if (v34) {
            float _a50[256];
            float *a50 = _a50;
            ...
            while (1) {
                ...
                v61 = a60[0];
                if (v59 + (-v53 + 256 <= (v61 + 257 - v59) % 257 ? -v53 +
                           256 : (v61 + 257 - v59) % 257) <= 257) {
                    host_read_shared(&shm28, a50, v59, v53, v53 + (-v53 + 256 <=
                                                                   (v61 + 257 -
                                                                    v59) %
                                                                   257 ? -v53 +
                                                                   256 : (v61 +
                    ...
                    host_read_shared(&shm28, a50, v59, v53, v53 + (-v59 + 257) -
                                     1);
                    host_read_shared(&shm28, a50, 0, v53 + (-v59 + 257), v53 +
                                     (-v59 + 257) + (-v53 + 256 <= (v61 + 257 -
                                                                    v59) %
                                                     257 ? -v53 + 256 : (v61 +
                                                                         257 -
                                                                         v59) %
                ...
                a62[0] = (v59 + (-v53 + 256 <= (v61 + 257 - v59) % 257 ? -v53 +
                                 256 : (v61 + 257 - v59) % 257)) % 257;
                host_write_local(&group0, 3, 3, la33, a62, 0, 0, 0);
                r51 = v53 + (-v53 + 256 <= (v61 + 257 - v59) % 257 ? -v53 +
                             256 : (v61 + 257 - v59) % 257);
            }
