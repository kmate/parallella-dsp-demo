...
volatile uint32_t *const la19 = (uint32_t *) 2159030288;
volatile uint32_t *const la20 = (uint32_t *) 2159030292;
volatile uint32_t *const la21 = (uint32_t *) 8196;
volatile float _Complex *const la22 = (float _Complex *) 8200;
volatile uint32_t *const la24 = (uint32_t *) 12304;
volatile uint32_t *const la25 = (uint32_t *) 12308;
