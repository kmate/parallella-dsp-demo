...
#include <stdint.h>
#include <tgmath.h>
volatile bool *const la12 = (bool *) 8192;
volatile bool *const la13 = (bool *) 8208;
volatile float _Complex *const la14 = (float _Complex *) 8224;
volatile bool *const la15 = (bool *) 2225086464;
volatile bool *const la16 = (bool *) 2225086480;
volatile float _Complex *const la17 = (float _Complex *) 2225086496;
...
int main()
{
    while (1) {
        ...
        r0 = 512;
        v2 = core_read_c2c(la14, la12, la13, a1, 0, r0);
        if (!v2) {
        ...
        v22 = core_write_c2c(la17, la15, la16, a1, 0, r0);
        if (!v22) {
