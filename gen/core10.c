...
volatile uint32_t *const la49 = (uint32_t *) 2291150864;
volatile uint32_t *const la50 = (uint32_t *) 2291150868;
volatile uint32_t *const la51 = (uint32_t *) 8196;
volatile float _Complex *const la52 = (float _Complex *) 8200;
volatile uint32_t *const la54 = (uint32_t *) 12304;
volatile uint32_t *const la55 = (uint32_t *) 12308;
