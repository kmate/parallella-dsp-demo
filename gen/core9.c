...
#include <stdint.h>
#include <tgmath.h>
volatile bool *const la27 = (bool *) 8192;
volatile bool *const la28 = (bool *) 8208;
volatile float _Complex *const la29 = (float _Complex *) 8224;
volatile bool *const la30 = (bool *) 2292195328;
volatile bool *const la31 = (bool *) 2292195344;
volatile float _Complex *const la32 = (float _Complex *) 2292195360;
...
int main()
{
    while (1) {
        ...
        r0 = 512;
        v2 = core_read_c2c(la29, la27, la28, a1, 0, r0);
        if (!v2) {
        ...
        v28 = core_write_c2c(la32, la30, la31, a1, 0, r0);
        if (!v28) {
