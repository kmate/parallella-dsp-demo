...
volatile uint32_t *const la69 = (uint32_t *) 2359312400;
volatile uint32_t *const la70 = (uint32_t *) 2359312404;
volatile uint32_t *const la71 = (uint32_t *) 8196;
volatile float _Complex *const la72 = (float _Complex *) 8200;
volatile uint32_t *const la74 = (uint32_t *) 16400;
volatile uint32_t *const la75 = (uint32_t *) 16404;
