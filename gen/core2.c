...
#include <string.h>
#include <tgmath.h>
volatile uint32_t *const la10 = (uint32_t *) 2156933140;
volatile uint32_t *const la11 = (uint32_t *) 8196;
volatile float _Complex *const la12 = (float _Complex *) 8200;
volatile uint32_t *const la14 = (uint32_t *) 12304;
volatile uint32_t *const la15 = (uint32_t *) 12308;
...
volatile uint32_t *const la9 = (uint32_t *) 2156933136;
