...
#include <string.h>
#include <tgmath.h>
volatile uint32_t *const la10 = (uint32_t *) 2156931092;
volatile uint32_t *const la11 = (uint32_t *) 8196;
volatile float _Complex *const la12 = (float _Complex *) 8200;
volatile uint32_t *const la14 = (uint32_t *) 10256;
volatile uint32_t *const la15 = (uint32_t *) 10260;
...
volatile uint32_t *const la9 = (uint32_t *) 2156931088;
    ...
    while (1) {
        ...
        while (1) {
            ...
            if (r55 > 0) {
                ...
                if (v48 + r55 <= r49) {
                    core_write_local(la17, a42, v48, v46, v46 + r55 - 1);
                } else {
                    uint32_t r57;
                    uint32_t r58;
                    
                    r57 = r49 - v48;
                    core_write_local(la17, a42, v48, v46, v46 + r57 - 1);
                    r58 = v46 + r57;
                    core_write_local(la17, a42, 0, r58, r58 + (r55 - r57) - 1);
                }
                let59 = v48 + r55;
                let60 = r49;
