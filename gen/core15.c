...
#include <stdint.h>
#include <tgmath.h>
volatile bool *const la36 = (bool *) 8192;
volatile bool *const la37 = (bool *) 8208;
volatile float _Complex *const la38 = (float _Complex *) 8224;
volatile bool *const la39 = (bool *) 2359304192;
volatile bool *const la40 = (bool *) 2359304208;
volatile float _Complex *const la41 = (float _Complex *) 2359304224;
...
int main()
{
    while (1) {
        ...
        r0 = 512;
        v2 = core_read_c2c(la38, la36, la37, a1, 0, r0);
        if (!v2) {
        ...
        v22 = core_write_c2c(la41, la39, la40, a1, 0, r0);
        if (!v22) {
